-- Shine Guard Hulo Database Schema (NO STORED PROCEDURES)
...
-- Insert Sample Streetlights (32 nodes)
...
-- Create Views for Dashboard (These work on all versions!)
...
-- SUCCESS MESSAGE
SELECT 'Database Hulo created successfully! Use login: admin / admin123' as Message;
