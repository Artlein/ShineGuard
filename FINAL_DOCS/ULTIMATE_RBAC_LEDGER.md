...
| **ADM_17** | **Seed Init** | Forensic Seed. | Admin logged | 1. Data & Backup -> [Initiate Seed]. 2. Enter Admin Password. | SQL Archive generated with SHA-256 seal. |
| **ADM_18** | **System Seed** | Forensic Re-Seed. | Seed exists | 1. [Verify & Restore] -> Enter Admin Pass. | Database state restored; Page reloads. |
