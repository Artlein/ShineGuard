    ...
    <div class="auth-card">
        ...
        <form id="criticalAuthForm">
            <div class="password-field">
                <input type="password" id="adminPassword" placeholder="Enter Administrator Password" autofocus required style="padding-right: 50px;">
                <button type="button" onclick="togglePassword()" style="position: absolute; right: 16px; top: 50%; transform: translateY(-50%); background: none; border: none; color: rgba(255,255,255,0.4); cursor: pointer; display: flex; align-items: center; justify-content: center; padding: 4px; transition: color 0.2s;" onmouseenter="this.style.color='white'" onmouseleave="if(document.getElementById('adminPassword').type==='password') this.style.color='rgba(255,255,255,0.4)'">
